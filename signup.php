...
<body>
	<div class="container">
		<div class="frame">
			<div class="nav">
				<ul class="links">
					<li class="signin-inactive"><a class="btn" href="login.php">Sign in</a></li>
					<li class="signup-active"><a class="btn">Sign up </a></li>
				</ul>
			</div>
			<div ng-app ng-init="checked = false">

				<form class="form-signin" action="signupctl.php" method="post" name="signupform">
					...
					<input class="form-styling" type="text" name="confirm" placeholder="Password" />

					<div class="btn-animate">
						<button class="btn-signin" type="submit" name="submit">Sign Up</button>
					</div>

					<div class="error-message" style="margin-top:100px">
						<?php 
